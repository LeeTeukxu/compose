...
<div style="height:190px;"><div class="mini-fit" >
        <div id="datagrid1" class="mini-datagrid" style="width: 100%;height: 100%"
             allowresize="true" url="/Claims/getClaimsType" sortfield="SN" sortorder="desc"
             autoload="true" onrowdblclick="onRowDblClick">
            <div property="columns">
                <#--<div type="indexcolumn"></div>-->
                <div type="checkcolumn"></div>
                <div field="typeName" id="typeName" name="typeName" width="200" headeralign="center" allowsort="true">
                    权利要求类型
                </div>
            </div>
        </div>
