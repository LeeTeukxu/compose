...
<div class="menuleft">
    <ul id="ul">
       <li id="my" onclick="SetIframeSrc('/homegrid?State=1')"><div class="menudiv"><img src="/img/syzhuanli.png" /> <span>我的专利</span></div></li>
        <li onclick="SetIframeSrc('/homegrid?State=2')"><div class="menudiv"><img src="/img/syzhuanli.png" /> <span>回收站</span></div></li>
<#--        <li onclick="SetIframeSrc('/mydownloads')"><div class="menudiv"><img src="/img/download.png" /> <span>我的下载</span></div></li>-->
        <li onclick="SetIframeSrc('/Template/templatecenter')"><div class="menudiv"><img src="/img/templatemeuli.png" /> <span>模板中心</span></div></li>
        <li onclick="SetIframeSrc('/Typo/index')"><div class="menudiv"><img src="/img/templatemeuli.png" /> <span>错字识别</span></div></li>
    <#--<li><div class="menudiv"><img src="/img/chongshu.png" /> <span>我的会员</span></div></li>
        <li><div class="menudiv"><img src="/img/jishufangan.png" /> <span>我的积分</span></div></li>-->
...
<div class="content" id="Attacheddrawings" >
    <iframe src="/homegrid?State=1" style="width: 123%;height: 900px;border: none" id="frame"></iframe>
</div>
