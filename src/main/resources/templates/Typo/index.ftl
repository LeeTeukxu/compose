...
<div style="height:800px;width: 100%">
    <div class="mini-fit" style="width: 100%;" id="fitt">
        <div class="mini-datagrid" id="grid1" style="width:100%;height:100%" allowcellselect="true" allowcelledit="true"
             url="/Typo/getTypoData?UserID=${UserID}" oncellbeginedit="beforeEdit" allowCellWrap="true"
             autoload="true" onselect="onSelectRow">
            <div property="columns">
                <div type="indexcolumn"></div>
                <div field="Mistake" width="300"  align="center" headerAlign="center">
                    错别词
                    <div property="editor" class="mini-textarea" style="width:100%;height:60px"></div>
                </div>
                <div field="Correct" width="300"  align="center" headerAlign="center">
                    正确参考词
                    <div property="editor" class="mini-textarea" style="width:100%;height:60px"></div>
                </div>
...
<script type="text/javascript">
    ...
    function onRemove() {
        ...
        if (row) {
            var fu = function () {
                var id = row["ID"];
                var url = '/Typo/removeTypo';
                $.post(url, {UserID:row["UserID"],ID: id }, function (r) {
                    if (r.success) {
                        mini.alert('选择记录删除成功!');
                        grid.reload();
                    }
