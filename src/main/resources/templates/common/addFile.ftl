...
<script type="text/javascript">
    var att = null;
    var mode = '${Mode}';
    var ZipFileLength = ${ZipFileLength};
    var num = 0;
    mini.parse();
    var xGrid = null;
    var xManager = null;
    ...
    $(function () {
        ...
        if (TechMainID) {
            fileGrid.load({TechMainID: TechMainID, Type:"Zip"});
            ...
            init: {
                ...
                FilesAdded: function (up, files) {
                    ...
                    for (var i = 0; i < files.length; i++) {
                        ...
                        fileNames.push(file.name + "-&" + ZipFileLength);
                    };
                ...
                if (rows.length > 0) {
                    ...
                    if (attId) {
                        ...
                        mini.confirm('确认要删除选择文件【' + fileName + '】?', '系统提示', function (btn) {
                            if (btn == 'ok') {
                                $.post(settings.removeUrl, {AttID: attId,TechMainID: TechMainID,Type: "Zip", Path: Path}, function (r, c) {
